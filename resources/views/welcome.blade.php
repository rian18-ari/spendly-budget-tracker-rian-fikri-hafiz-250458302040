...
<body>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-amber-50 shadow-lg rounded-xl p-8 text-center border-2 transform hover:-translate-y-2 transition duration-300" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="mb-6 text-cyan-700">Kami mentransformasi pelacakan pengeluaran menjadi manajemen spending. Spendly memberikan tim kamu kemampuan untuk mengendalikan anggaran dari awal, bukan hanya merekonsiliasi di akhir.</p>
                </div>
                {{-- start card 02 --}}
                <div class="bg-amber-50 shadow-lg rounded-xl p-8 text-center border-2 transform hover:-translate-y-2 transition duration-300" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="mb-6 text-cyan-700">Dapatkan visualisasi real-time dari setiap transaksi yang dilakukan. Dashboard Spendly memungkinkan kamu mengidentifikasi anomali atau overspend seketika untuk intervensi yang cepat dan tepat.</p>
                </div>
                {{-- start card 03 --}}
                <div class="bg-amber-50 shadow-lg rounded-xl p-8 text-center border-2 transform hover:-translate-y-2 transition duration-300" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p class="mb-6 text-cyan-700">Spendly memastikan kepatuhan kebijakan perusahaan secara otomatis. Kami menyiapkan jejak audit yang rapi dan terverifikasi (Audit Trail) sehingga proses peninjauan finansial menjadi sederhana dan bebas stres.</p>
                </div>
            </div>
            {{-- end card --}}
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white shadow-lg rounded-xl p-8 text-center border-2 transform hover:-translate-y-2 transition duration-300 flex flex-col justify-between" data-aos="fade-up" data-aos-delay="100">
                    <div>
                        ...
                        <p class="mb-6 text-cyan-700">Jangan biarkan data kamu terisolasi. Dengan satu klik, kamu bisa ekspor semua data transaksi ke format Excel. Ini memudahkan analisis mendalam, pelaporan ke direksi, dan integrasi dengan sistem akuntansi eksternal (ERP) kamu.</p>
                    </div>
                </div>
                ...
                <div class="bg-white shadow-lg rounded-xl p-8 text-center border-2 transform hover:-translate-y-2 transition duration-300 flex flex-col justify-between" data-aos="fade-up" data-aos-delay="200">
                    <div>
                        ...
                        <p class="mb-6 text-cyan-700">Sediakan visibilitas penuh bagi role Admin untuk memvalidasi status setiap transaksi sebelum diproses. Fitur ini memastikan tidak ada transaksi fiktif atau yang tidak sah lolos, memberikan lapisan keamanan dan kontrol akhir pada arus kas perusahaan.</p>
                    </div>
                </div>
                ...
                <div class="bg-white shadow-lg rounded-xl p-8 text-center border-2 transform hover:-translate-y-2 transition duration-300 flex flex-col justify-between" data-aos="fade-up" data-aos-delay="300">
                    <div>
                        ...
                        <h2 class="text-2xl font-bold mb-4 text-cyan-900">Pendelegasian Budget Berbasis Akuntabilitas</h2>
                        <p class="mb-6 text-cyan-700">Alokasikan dana spesifik langsung ke karyawan, tim, atau proyek. Fitur ini menciptakan akuntabilitas biaya yang jelas, memastikan pengeluaran selalu di bawah kontrol, dan menghilangkan kebingungan tentang sisa budget yang tersedia bagi setiap pemegang dana.</p>
                    </div>
                </div>
            </div>
            {{-- end card --}}
    ...
    {{-- section unknown --}}
    <section class="w-full h-72 m-4">
        <div class="w-full h-full flex items-center justify-center" data-aos="fade-up" data-aos-duration="1000">
            <img src="{{ asset('asset/img/spendly-high-resolution-logo-transparent.png') }}" alt="" class="w-full h-full">
        </div>
    </section>
    {{-- end section unknown --}}
    ...
    <footer class="bg-white rounded-lg">
        <div class="bg-gray-50 text-center p-4 rounded-lg border-2 m-4 shadow text-cyan-900">
            ...
            <p>made with love by <a href="https://rian18-ari.github.io/ari-dev-rian-fikri-hafiz-250458302040/" target="_blank" class="hover:text-blue-500">rian fikri hafiz</a></p>
        </div>
    </footer>
    {{-- end footer --}}
