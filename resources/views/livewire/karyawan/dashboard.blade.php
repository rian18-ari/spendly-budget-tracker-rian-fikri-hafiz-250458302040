...
<div class="w-md lg:w-full md:w-full">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="p-6 rounded-xl shadow-lg border-2 bg-amber-50 col-span-1 md:col-span-2">
            ...
            <p class="text-sm font-bold text-cyan-900 mt-1">Rp.
                {{ number_format($nominalTerbesar->amount ?? 0, 0, ',', '.') }}</p>
        </div>
        <div class="p-6 rounded-xl shadow-lg border-2 bg-amber-50 col-span-1 md:col-span-2">
            <p class="text-sm font-medium text-gray-500">Total Transaksi</p>
            <p class="text-3xl font-bold text-cyan-900 mt-1">{{ $totalTransaksi }}</p>
        </div>
    </div>
