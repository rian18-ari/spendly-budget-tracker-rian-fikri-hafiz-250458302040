...
<div class="w-md lg:w-full">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        <div class="p-6 rounded-xl shadow-lg border-2 bg-amber-50 w-auto mb-6">
            <h3 class="text-xl font-medium text-gray-500 pb-2">Jumlah Pegawai</h3>
    ...
    <div class="space-y-5 sm:space-y-6">
        <div class="rounded-2xl border-2 shadow-lg border-gray-200 bg-white dark:border-gray-800">
            <div class="px-6 py-5 flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <div class="justify-end flex flex-col sm:flex-row w-full sm:w-auto gap-2">
                    <input type="text" wire:model.live.debounce.500ms="search" placeholder="Cari Karyawan..."
                        class="px-2 py-3 border-2 rounded-lg w-full sm:w-auto h-9 items-center flex mr-2">
                    <div
                                        ...
                                        @forelse ($karyawans as $item)
                                            <tr class="border-t border-gray-100 dark:border-gray-800 hover:bg-gray-200">
                                                ...
                                                <td class="px-5 py-4 sm:px-6 flex gap-2">
                                                    <button
                                                        @click="showModal = true; $wire.confirmDelete({{ $item->id }})"
                                                ...
                                                <div class="sm:flex sm:items-start">
                                                    ...
                                                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                        <h3 class="text-base font-semibold leading-6 text-gray-900"
                                                            id="modal-title">Hapus Data Karyawan</h3>
                                                        <div class="mt-2">
                                                            <p class="text-sm text-gray-500">Yakin mau hapus data
                                                                karyawan ini?</p>
                                                        </div>
                                                    </div>
                                                </div>
