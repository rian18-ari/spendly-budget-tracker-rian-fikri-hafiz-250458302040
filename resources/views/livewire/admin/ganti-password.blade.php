...
<div class="border-2 rounded-lg w-auto h-auto p-6 bg-amber-50">
    {{-- <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8"> --}}
        <div class="mt-5 md:mt-0 md:col-span-2">
            ...
            <div
                class="bg-gray-700/25 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 mt-4 w-full rounded-lg gap-4">
                ...
                <a wire:navigate href="{{route('dashboardadmin')}}" class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">
                    Kembali
                </a>
