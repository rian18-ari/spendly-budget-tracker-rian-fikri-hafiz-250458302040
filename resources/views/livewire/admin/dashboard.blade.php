...
<div class="lg:w-full sm:w-full">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="p-6 rounded-xl shadow-lg border-2 bg-amber-50 col-span-1 md:col-span-2 lg:col-span-4">
        ...
        <div class="p-6 rounded-xl shadow-lg border-2 bg-amber-50 col-span-1 md:col-span-2">
    ...
    <!-- Chart Section -->
    <div class="bg-white p-6 rounded-xl shadow-lg mb-6 border-2 lg:flex lg:flex-row">
        <h3 class="text-xl font-semibold text-gray-800 mb-4">Laporan Aktivitas Bulanan</h3>
        <div class="bg-gray-50 rounded-lg flex flex-col lg:flex-row justify-between">
            <div class="w-full p-4">
                <canvas id="budgetChart" class="w-full h-96"></canvas>
            </div>
            <div class="w-full overflow-x-auto">
                <table class="w-full divide-y divide-gray-200 border border-gray-300 rounded-lg">
                ...
                try {
                    ...
                    if (!labels || !data || labels.length === 0 || data.length === 0) {
                        ...
                        ctx.parentElement.innerHTML =
                            '<p class="text-center text-lg text-gray-500 py-12">Tidak ada data untuk ditampilkan.</p>';
                        return;
                    }
                    ...
                    ctx.parentElement.innerHTML =
                        '<p class="text-center text-lg text-red-500 py-12">Error memuat data chart: ' + e.message + '</p>';
                }
            }
